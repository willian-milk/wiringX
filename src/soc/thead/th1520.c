...
static struct layout_t {
	...
	{"GPIO2_23", 2, 2, {G3_MUXCFG_003, 28, 0x00}, {GPIO_SWPORTA_DDR, 23}, {GPIO_SWPORTA_DR, 23}, {GPIO_EXT_PORTA, 23}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	...
	{"GPIO4_0", 0, 5, {G1_MUXCFG_004, 4, 0x03}, {GPIO_SWPORTA_DDR, 0}, {GPIO_SWPORTA_DR, 0}, {GPIO_EXT_PORTA, 0}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_1", 0, 5, {G1_MUXCFG_004, 8, 0x03}, {GPIO_SWPORTA_DDR, 1}, {GPIO_SWPORTA_DR, 1}, {GPIO_EXT_PORTA, 1}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_2", 0, 5, {G1_MUXCFG_004, 12, 0x03}, {GPIO_SWPORTA_DDR, 2}, {GPIO_SWPORTA_DR, 2}, {GPIO_EXT_PORTA, 2}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_3", 0, 5, {G1_MUXCFG_004, 16, 0x03}, {GPIO_SWPORTA_DDR, 3}, {GPIO_SWPORTA_DR, 3}, {GPIO_EXT_PORTA, 3}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_4", 0, 5, {G1_MUXCFG_004, 20, 0x03}, {GPIO_SWPORTA_DDR, 4}, {GPIO_SWPORTA_DR, 4}, {GPIO_EXT_PORTA, 4}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_5", 0, 5, {G1_MUXCFG_004, 24, 0x03}, {GPIO_SWPORTA_DDR, 5}, {GPIO_SWPORTA_DR, 5}, {GPIO_EXT_PORTA, 5}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_6", 0, 5, {G1_MUXCFG_004, 28, 0x03}, {GPIO_SWPORTA_DDR, 6}, {GPIO_SWPORTA_DR, 6}, {GPIO_EXT_PORTA, 6}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_7", 0, 5, {G1_MUXCFG_005, 0, 0x03}, {GPIO_SWPORTA_DDR, 7}, {GPIO_SWPORTA_DR, 7}, {GPIO_EXT_PORTA, 7}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_8", 0, 5, {G1_MUXCFG_005, 4, 0x03}, {GPIO_SWPORTA_DDR, 8}, {GPIO_SWPORTA_DR, 8}, {GPIO_EXT_PORTA, 8}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_9", 0, 5, {G1_MUXCFG_005, 8, 0x03}, {GPIO_SWPORTA_DDR, 9}, {GPIO_SWPORTA_DR, 9}, {GPIO_EXT_PORTA, 9}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_10", 0, 5, {G1_MUXCFG_005, 12, 0x03}, {GPIO_SWPORTA_DDR, 10}, {GPIO_SWPORTA_DR, 10}, {GPIO_EXT_PORTA, 10}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_11", 0, 5, {G1_MUXCFG_005, 16, 0x03}, {GPIO_SWPORTA_DDR, 11}, {GPIO_SWPORTA_DR, 11}, {GPIO_EXT_PORTA, 11}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_12", 0, 5, {G1_MUXCFG_005, 20, 0x03}, {GPIO_SWPORTA_DDR, 12}, {GPIO_SWPORTA_DR, 12}, {GPIO_EXT_PORTA, 12}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_13", 0, 5, {G1_MUXCFG_005, 24, 0x03}, {GPIO_SWPORTA_DDR, 13}, {GPIO_SWPORTA_DR, 13}, {GPIO_EXT_PORTA, 13}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_14", 0, 5, {G1_MUXCFG_005, 28, 0x03}, {GPIO_SWPORTA_DDR, 14}, {GPIO_SWPORTA_DR, 14}, {GPIO_EXT_PORTA, 14}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_15", 0, 5, {G1_MUXCFG_006, 0, 0x03}, {GPIO_SWPORTA_DDR, 15}, {GPIO_SWPORTA_DR, 15}, {GPIO_EXT_PORTA, 15}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_16", 0, 5, {G1_MUXCFG_006, 4, 0x03}, {GPIO_SWPORTA_DDR, 16}, {GPIO_SWPORTA_DR, 16}, {GPIO_EXT_PORTA, 16}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_17", 0, 5, {G1_MUXCFG_006, 8, 0x03}, {GPIO_SWPORTA_DDR, 17}, {GPIO_SWPORTA_DR, 17}, {GPIO_EXT_PORTA, 17}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_18", 0, 5, {G1_MUXCFG_006, 12, 0x03}, {GPIO_SWPORTA_DDR, 18}, {GPIO_SWPORTA_DR, 18}, {GPIO_EXT_PORTA, 18}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_19", 0, 5, {G1_MUXCFG_006, 16, 0x03}, {GPIO_SWPORTA_DDR, 19}, {GPIO_SWPORTA_DR, 19}, {GPIO_EXT_PORTA, 19}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_20", 0, 5, {G1_MUXCFG_006, 20, 0x03}, {GPIO_SWPORTA_DDR, 20}, {GPIO_SWPORTA_DR, 20}, {GPIO_EXT_PORTA, 20}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_21", 0, 5, {G1_MUXCFG_006, 24, 0x03}, {GPIO_SWPORTA_DDR, 21}, {GPIO_SWPORTA_DR, 21}, {GPIO_EXT_PORTA, 21}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"GPIO4_22", 0, 5, {G1_MUXCFG_001, 28, 0x03}, {GPIO_SWPORTA_DDR, 22}, {GPIO_SWPORTA_DR, 22}, {GPIO_EXT_PORTA, 22}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	...
	{"AOGPIO_0", 0, 4, {G1_MUXCFG_002, 4, 0x03}, {GPIO_SWPORTA_DDR, 0}, {GPIO_SWPORTA_DR, 0}, {GPIO_EXT_PORTA, 0}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"AOGPIO_1", 0, 4, {G1_MUXCFG_004, 8, 0x03}, {GPIO_SWPORTA_DDR, 1}, {GPIO_SWPORTA_DR, 1}, {GPIO_EXT_PORTA, 1}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"AOGPIO_2", 0, 4, {G1_MUXCFG_004, 12, 0x03}, {GPIO_SWPORTA_DDR, 2}, {GPIO_SWPORTA_DR, 2}, {GPIO_EXT_PORTA, 2}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"AOGPIO_3", 0, 4, {G1_MUXCFG_004, 16, 0x03}, {GPIO_SWPORTA_DDR, 3}, {GPIO_SWPORTA_DR, 3}, {GPIO_EXT_PORTA, 3}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"AOGPIO_4", 0, 4, {G1_MUXCFG_004, 20, 0x03}, {GPIO_SWPORTA_DDR, 4}, {GPIO_SWPORTA_DR, 4}, {GPIO_EXT_PORTA, 4}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"AOGPIO_5", 0, 4, {G1_MUXCFG_004, 24, 0x03}, {GPIO_SWPORTA_DDR, 5}, {GPIO_SWPORTA_DR, 5}, {GPIO_EXT_PORTA, 5}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"AOGPIO_6", 0, 4, {G1_MUXCFG_004, 28, 0x03}, {GPIO_SWPORTA_DDR, 6}, {GPIO_SWPORTA_DR, 6}, {GPIO_EXT_PORTA, 6}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"AOGPIO_7", 0, 4, {G1_MUXCFG_003, 0, 0x03}, {GPIO_SWPORTA_DDR, 7}, {GPIO_SWPORTA_DR, 7}, {GPIO_EXT_PORTA, 7}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"AOGPIO_8", 0, 4, {G1_MUXCFG_003, 4, 0x03}, {GPIO_SWPORTA_DDR, 8}, {GPIO_SWPORTA_DR, 8}, {GPIO_EXT_PORTA, 8}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"AOGPIO_9", 0, 4, {G1_MUXCFG_003, 8, 0x03}, {GPIO_SWPORTA_DDR, 9}, {GPIO_SWPORTA_DR, 9}, {GPIO_EXT_PORTA, 9}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"AOGPIO_10", 0, 4, {G1_MUXCFG_003, 12, 0x03}, {GPIO_SWPORTA_DDR, 10}, {GPIO_SWPORTA_DR, 10}, {GPIO_EXT_PORTA, 10}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"AOGPIO_11", 0, 4, {G1_MUXCFG_003, 16, 0x00}, {GPIO_SWPORTA_DDR, 11}, {GPIO_SWPORTA_DR, 11}, {GPIO_EXT_PORTA, 11}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"AOGPIO_12", 0, 4, {G1_MUXCFG_003, 20, 0x00}, {GPIO_SWPORTA_DDR, 12}, {GPIO_SWPORTA_DR, 12}, {GPIO_EXT_PORTA, 12}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"AOGPIO_13", 0, 4, {G1_MUXCFG_003, 24, 0x00}, {GPIO_SWPORTA_DDR, 13}, {GPIO_SWPORTA_DR, 13}, {GPIO_EXT_PORTA, 13}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"AOGPIO_14", 0, 4, {G1_MUXCFG_003, 28, 0x00}, {GPIO_SWPORTA_DDR, 14}, {GPIO_SWPORTA_DR, 14}, {GPIO_EXT_PORTA, 14}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
	{"AOGPIO_15", 0, 4, {G1_MUXCFG_004, 0, 0x00}, {GPIO_SWPORTA_DDR, 15}, {GPIO_SWPORTA_DR, 15}, {GPIO_EXT_PORTA, 15}, FUNCTION_DIGITAL, PINMODE_NOT_SET, 0},
